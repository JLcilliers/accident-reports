      ...
      <div className="max-w-4xl mx-auto py-12">
        ...
        <div className="prose max-w-none space-y-6 text-gray-700">
          <section>
            ...
            <p>
              By accessing and using AccidentReports.com (the "Service"), you accept and agree to be bound
          ...
          <section>
            ...
            <p>
              AccidentReports.com provides a free service to help users locate and obtain accident and
              police reports. We search various databases and public records to find reports matching
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4">4. Privacy and Data Use</h2>
            <p>
          ...
          <section>
            ...
            <p>
              To the maximum extent permitted by law, AccidentReports.com shall not be liable for any
          ...
          <section>
            <h2 className="text-2xl font-bold mb-4">7. Legal Referrals</h2>
            <p>
          ...
          <section>
            ...
            <p className="mt-3">
              Email: legal@accidentreports.com
            </p>
          </section>
        </div>
      </div>

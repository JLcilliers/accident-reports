    ...
    <>
      ...
      <section className="relative text-white overflow-hidden min-h-[680px] lg:min-h-[760px] flex items-center">
        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-20 py-16 lg:py-28 max-w-[1200px]">
          <div className="max-w-[560px] ml-[10px] lg:ml-[20px]">
            ...
            {/* CTAs - Enhanced primary solid blue, secondary white with blue border */}
            <div className="flex flex-col sm:flex-row gap-4 mb-7">
              <Link
                href="/get-report/step-1"
                className="inline-flex items-center justify-center bg-blue-600 text-white px-8 py-4 min-h-[48px] rounded-lg font-bold text-base hover:bg-blue-700 transition-all shadow-lg hover:shadow-xl"
              >
              ...
              <Link
                href="/legal-help"
                className="inline-flex items-center justify-center bg-white text-blue-600 px-7 py-3.5 min-h-[48px] rounded-lg font-semibold text-base hover:bg-gray-50 transition-all border-2 border-blue-600"
              >
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="container mx-auto px-6 lg:px-12 max-w-[1200px]">
          ...
          {/* Three elevated cards - content-driven heights with soft shadows */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            {/* Step 1 */}
            <div className="bg-white rounded-lg p-6 shadow-[0_12px_24px_rgba(15,23,42,0.04)] border border-gray-200 hover:shadow-[0_16px_32px_rgba(15,23,42,0.08)] transition-shadow">
      ...
      {/* TRUST / STATS SECTION - Light background band #F5F7FB */}
      <section className="py-16 lg:py-20 bg-[#F5F7FB] border-t border-gray-200">
        <div className="container mx-auto px-6 lg:px-12 max-w-[1200px]">
          ...
          {/* Stats with vertical dividers and consistent blue styling */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            {/* Stat 1 */}
            <div className="bg-white rounded-lg p-8 text-center shadow-[0_12px_24px_rgba(15,23,42,0.04)] border border-gray-200 relative">
            ...
            <div className="hidden md:block absolute top-1/2 left-1/3 -translate-x-1/2 -translate-y-1/2 w-px h-24 bg-[#CBD5E1]"></div>
            ...
            <div className="bg-white rounded-lg p-8 text-center shadow-[0_12px_24px_rgba(15,23,42,0.04)] border border-gray-200 relative">
              ...
              <div className="text-5xl font-bold text-blue-600 mb-2 tracking-tight">24/7</div>
              <p className="text-gray-600 font-semibold text-sm uppercase tracking-wide">Support Available</p>
            </div>

            {/* Vertical divider - hidden on mobile */}
            <div className="hidden md:block absolute top-1/2 left-2/3 -translate-x-1/2 -translate-y-1/2 w-px h-24 bg-[#CBD5E1]"></div>
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="container mx-auto px-6 lg:px-12 max-w-[1200px]">
          <div className="lg:grid lg:grid-cols-12 lg:gap-12">
            {/* Left column - Section header with accent bar (35% width) */}
            <div className="lg:col-span-4 mb-10 lg:mb-0 lg:pr-8 border-l-4 border-blue-600 pl-6">
            ...
            <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-6">
              {/* Benefit 1 */}
              <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-[0_12px_24px_rgba(15,23,42,0.04)] hover:shadow-[0_16px_32px_rgba(15,23,42,0.08)] transition-shadow">
      ...
      {/* CTA BANNER SECTION - Blue background with subtle dots and offset layout */}
      <section className="relative min-h-[220px] py-16 lg:py-20 bg-blue-600 overflow-hidden">
        {/* Subtle dot texture */}
        ...
        <div className="container mx-auto px-6 lg:px-12 max-w-[1200px] relative">
          <div className="lg:flex lg:items-center lg:gap-12 text-center lg:text-left">
            ...
            <div className="lg:flex-shrink-0">
              <Link
                href="/get-report/step-1"
                className="inline-flex items-center justify-center bg-white text-blue-600 px-8 py-4 rounded-lg font-bold text-base hover:bg-gray-50 transition-all shadow-lg"
              >
                Get Started Now
                <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M13 7l5 5m0 0l-5 5m5-5H6"/>
